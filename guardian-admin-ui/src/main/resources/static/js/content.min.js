...
if ($(".tooltip-demo").tooltip({
        ...
        var o = $(this).closest("../error/ie.html"), e = $(this).find("i"), i = o.find("div.ibox-content");
        ...
        var o = $(this).closest("../error/ie.html");
        o.remove()
    }), top == this) {
    var gohome = '<div class="gohome"><a class="animated bounceInUp" href="../error/ie.html" title="返回首页"><i class="fa fa-home"></i></a></div>';
    $("body").append(gohome)
}