 ...
 function showDialog(url){
      var statusParms="dialogHeight: 600px; dialogWidth: 1000px; center: yes; help: no; resizable: yes; status: no; scroll: no;";
      window.showModalDialog(url,"model",statusParms);
 }
...
/** 导出为Excel */
function exportExcel(formName, exportAction){
	var form = document.getElementsByName(formName)[0];
